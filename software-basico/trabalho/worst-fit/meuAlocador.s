...
alocaMem:
    ...
    movq %rsp, %rbp     # %rbp = %rsp
                    ...
                    # %rdi = num_bytes
    subq $40, %rsp  # aloca espaco para 8 variaveis
                    #  -8(%rbp): long int *inicio_busca
                    # -16(%rbp): void *topo_heap
                    # -24(%rbp): int tamanho
                    # -32(%rbp): long int *posi_aux
                    # -40(%rbp): long int *novo_bloco

    # long int *inicio_busca = busca_anterior;
    movq topo_inicial_heap, %r11
    movq %r11, -8(%rbp)
	...
	# int tamanho = -1;
    movq $-1, -24(%rbp)             # -24(%rbp) [int tamanho] = -1

	# long int *posi_aux = NULL;
    movq $0, -32(%rbp)  # -32(%rbp) [long int *posi_aux] = 0

    # while ( inicio_busca != topo_heap ){
    while_2:
    movq -8(%rbp), %r12         # %r12 = -8(%rbp) [long int *inicio_busca]
    movq -16(%rbp), %r13        # %r13 = -16(%rbp) [void *topo_heap]
    cmp %r13, %r12
    je fim_while_2
        ...
        jne fim_if2
            ...
            movq -8(%rbp), %r14            # %r14 = -8(%rbp) [long int *inicio_busca]
            movq 8(%r14), %r14             # %r14 = inicio_busca[1]
            movq -24(%rbp), %r15           # %r15 = -24(%rbp) [int tamanho]
            cmp %r15, %r14
            jle fim_if5 

				# posi_aux = inicio_busca;
                movq -8(%rbp), %r14            # %r14 = -8(%rbp) [long int *inicio_busca]
                movq %r14, -32(%rbp)           # -32(%rbp) [long int *posi_aux] = %r14

                # tamanho = inicio_busca[1];
                movq -8(%rbp), %r14            # %r14 = -8(%rbp) [long int *inicio_busca]
                movq 8(%r14), %r15             # %r15 = inicio_busca[1]
                movq %r15, -24(%rbp)           # -24(%rbp) [int tamanho] = %r15
    ...
    # if ( tamanho != -1 ){
    movq -24(%rbp), %r14             # %r14 = -24(%rbp) [int tamanho]
    cmp $-1, %r14
    je fim_if6
     
        # if ( posi_aux[1] > num_bytes + 16 ){
            movq -32(%rbp), %r14         # %r14 = -32(%rbp) [long int *posi_aux]
            movq 8(%r14), %r14          # %r14 = 8(%r14) [long int posi_aux[1]]
            movq $16, %r15              # %r15 = 16
            addq %rdi, %r15             # %r15 = %rdi [num_bytes] + 16 
            cmp %r15, %r14
            jle else_if3

                # long int bloco_atual_tam = posi_aux[1];
                movq -32(%rbp), %r14         # %r14 = -32(%rbp) [long int *posi_aux]
                movq 8(%r14), %r14          # %r14 = 8(%r14) [long int posi_aux[1]]
                ...
                movq -32(%rbp), %r14         # %r14 = -32(%rbp) [long int *posi_aux]
                movq $1, %r15               # %r15 = 1
                movq %r15, (%r14)           # (%r14) [posi_aux[0]] = 1

                # posi_aux[1] = num_bytes;
                movq -32(%rbp), %r14         # %r14 = -32(%rbp) [long int *posi_aux]
                movq %rdi, 8(%r14)          # 8(%r14) [posi_aux[1]] = %rdi [num_bytes]
                ...
                movq -32(%rbp), %rax         # %rax = -32(%rbp) [long int *posi_aux]
                addq $16, %rax              # %rax += 16

                addq $40, %rsp  # desaloca espaco para 8 variaveis
                popq %rbp
                ret
